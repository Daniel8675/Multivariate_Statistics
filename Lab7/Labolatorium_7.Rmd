...
Chcemy skonstruować klasyfikator z dwoma klasami: dużo zarabiających (więcej niż 250 000 dolarów: warunek `wage > 250`) i mało zarabiających (pozostali). Predyktorem jest `age`, ale chcemy też uwzględnić wpływ wyższych potęg (do 4) tej zmiennej.
